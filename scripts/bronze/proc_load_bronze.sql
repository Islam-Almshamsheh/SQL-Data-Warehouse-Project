...
Script Purpose:
  ...
  It performs the following actions:
    ...
    - Calculate the execution time for each truncate/load operation per table, as
      well as the total time for the Bronze layer load
...
BEGIN
	...
	BEGIN TRY
		...
		--INSERT DATA TO THE TABLES USING BULK INSERT METHOD
		PRINT '===================================================';
		...
		PRINT 'Duration For Loading the Bronze Stored Procedure: ' + CAST(DATEDIFF(second, @batch_start_time, @batch_end_time) AS NVARCHAR) + 'seconds';
		PRINT '===================================================';
